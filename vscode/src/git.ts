...
export class Git extends Disposable {
     ...
     *
     * @param repositoryOrDirectory The repository or directory to execute the command in.
     * @param args The arguments to pass to Git.
     * @returns The output of the command.
     */
    public async exec(
        repositoryOrDirectory: Repository | string,
        ...args: string[]
    ): Promise<string> {
        ...
        child = spawn(this.api.git.path, args, {
            cwd:
                typeof repositoryOrDirectory === 'string'
                    ? repositoryOrDirectory
                    : repositoryOrDirectory.rootUri.fsPath
        });
